...
CREATE TABLE Kunde(
	KundenNr NUMERIC(10) CONSTRAINT KdrNR_PK PRIMARY KEY,
	Vorname VARCHAR2(20) NOT NULL,
	Name VARCHAR2(20) NOT NULL,
	Strasse VARCHAR2(20),
	PLZ NUMERIC(5) NOT NULL,
...
CREATE Table Auto(
	Modell VARCHAR2(50),
	Sitze NUMERIC(2) NOT NULL,
	Kennzeichen VARCHAR2(15) ,
	Besitzer NUMERIC(10), --CONSTRAINT ZugAuto_Kunde  REFERENCES Kunde(KundenNr)
...
CREATE TABLE GESUCH(
	Suchender NUMERIC(10)constraint Gesuch_Kunde REFERENCES Kunde(KundenNr), 
	
--	constraint Gesuch_Kunde FOREIGN KEY(Suchender) REFERENCES Kunde(KundenNr),
	
	
	GesuchNr NUMERIC(10) CONSTRAINT GesuchNR_PK PRIMARY KEY,
...
--  Constraint angebot_ziel_ortSK FOREIGN KEY(Ort_Ziel) REFERENCES Ort(Name),
	...
	Gesuchte_Plaetze   NUMERIC(2)     NOT NULL,
...
CREATE TABLE Angebot(
	Bietender NUMERIC(10) Constraint Angebot_Kunde REFERENCES Kunde(KundenNr),
	
--	constraint Angebot_Kunde FOREIGN KEY(Bietender) REFERENCES Kunde(KundenNr),
	AngebotNr NUMERIC(10) CONSTRAINT AngebotNR_PK PRIMARY KEY,
...
--  Constraint angebot_ueber_ortSK FOREIGN KEY(Ort_ueber) REFERENCES Ort(Name),
	...
	Fruehste_Startzeit TIMESTAMP(0)  NOT NULL,
	Spateste_Startzeit TIMESTAMP(0)  NOT NULL,
	Gebotene_Plaetze   NUMERIC(2)     NOT NULL,
...
CREATE TABLE Beziehung_Kunde_Gesuch(
	GesuchNr NUMERIC(10), --constraint kunde_gesuch_gesuchNR_pk REFERENCES GESUCH(GesuchNr),
	KundenNr NUMERIC(10), --1constraint kunde_gesuch_KundenNR_pk REFERENCES Kunde(KundenNr),
...
CREATE TABLE Beziehung_Kunde_Angebot(
	AngebotNr NUMERIC(10),-- constraint kunde_angebot_gesuchNR_pk REFERENCES Angebot(AngebotNr),
	KundenNr NUMERIC(10),-- constraint kunde_angebot_KundenNR_pk REFERENCES Kunde(KundenNr),
